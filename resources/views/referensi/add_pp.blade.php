        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <h4 class="page-title">Tambah Panitera Pengganti</h4>
                    <ol class="breadcrumb">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="mt-0 header-title mb-4">Tambah Panitera Pengganti</h4>
                            <div class="col d-md-flex justify-content-center">
                                <form method="post" action="{{ url('/admin/insert_pp') }}" class="col-md-6">
                                    @csrf
